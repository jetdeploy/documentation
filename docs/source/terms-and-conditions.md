...
**PLEASE READ THESE TERMS AND CONDITIONS ("AGREEMENT") CAREFULLY. BY ACCESSING OR USING THE JETDEPLOY PLATFORM ("SERVICE"), YOU AGREE TO BE BOUND BY THIS AGREEMENT. IF YOU DO NOT AGREE, DO NOT USE THE SERVICE.**
...
We are developers like you, and we understand the values and trust that you deserve. Therefore:

- We **work hard** to maintain a **secure and hardened** infrastructure.
- We **never** access your repository code.
- We **never** access your data.
- We **never** share your profile with anyone.

Our specialists are dedicated to ensuring the best experience for you and your clients. If anything concerns you, please let us know.
...
- **"Service"** – The online services provided by JetDeploy, including any related websites, applications, and tools.
- **"Content"** – All text, data, software, images, video, and audio provided through the Service.
...
- **Modifications:** JetDeploy may modify or discontinue the Service at any time without liability.
...
- **Changes:** JetDeploy reserves the right to change fees and payment policies with prior notice.
...
- Cryptocurrency mining (server-side);  
- Profane, obscene, or offensive content;  
- Hate speech, violent content, or material promoting intolerance;  
- Computer hacking or cracking;  
- Gambling-related applications or content;  
- Illegal activities, including the export of controlled substances or software;  
- Drug-related content;  
- Phishing sites or deceptive practices;  
- Malware, viruses, or any other malicious content;  
- Pornographic, sexually explicit, or adult-oriented content;  
- Any material violating criminal laws, other applicable laws, or third-party rights.  

Violation may result in account termination without notice and potential legal action. 
...
- **Data Controller:** JetDeploy is the data controller for any personal data you provide through our Service.
- **Personal Data We Collect:** When you use our Service, we collect personal data, including but not limited to your name, email address, and usage data. We may also collect financial information (such as billing details) when processing payments.
- **Use of Personal Data:** We use your personal data to:
  - Provide and improve our Service
  - Manage your account and billing
  - Communicate with you about your account and service-related updates
  - Comply with legal obligations

- **Legal Basis for Processing:** The legal bases for processing your personal data include:
  - Performance of a contract (e.g., to provide the Service and process payments)
  - Consent (for certain communications or marketing purposes)
  - Legitimate interests (e.g., to maintain and improve the Service)

- **Data Retention:** Your personal data will be retained for as long as necessary to fulfill the purposes outlined in this Agreement or as required by law.
...
- **Data Subject Rights:**
  ...
  - **Right to Restrict Processing:** You may request that we limit the processing of your personal data in certain situations.
...
To exercise any of these rights, please contact us at **legal@jetdeploy.com**.

- **Data Transfers:** Your personal data may be transferred to and processed in countries outside the European Economic Area (EEA). We ensure that appropriate safeguards are in place to protect your data when transferred.

- **Third-Party Services:** We do not sell, trade, or rent your personal data to third parties. However, we may share your data with trusted third-party service providers who assist us in operating our Service (e.g., payment processors, cloud hosting providers). These third parties are required to maintain the confidentiality and security of your data.

- **Privacy Policy Changes:** We may update this Privacy Policy from time to time. When we make changes, we will update the "Last Updated" date at the top of this policy. We encourage you to review this Privacy Policy periodically for any updates. Continued use of the Service after the changes are made indicates your acceptance of those changes.
...
Any third-party claims relating to your use of the Service.
